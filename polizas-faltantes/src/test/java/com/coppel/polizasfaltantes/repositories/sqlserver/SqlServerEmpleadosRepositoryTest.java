...
public class SqlServerEmpleadosRepositoryTest {
    @Mock
    ...
    @InjectMocks
    private SqlServerEmpleadosRepository sqlServerEmpleadosRepository;
    ...
    public void testGetAllEmptyRecords() {
        ...
        List<Empleado> records = this.generate(total).getRecords();

        Map<String, Object> expectedResult = new HashMap<>();
        expectedResult.put("empleados", records);
        ...
        final Pagination<Empleado> result = sqlServerEmpleadosRepository.getAll();
    ...
    public void testGetAllWitoutParameters() {
        ...
        assertEquals(SqlServerEmpleadosRepository.DEFAULT_LIMIT, result.getLimit());
    ...
    public void testGetAllWithDefaultLimitParameter() {
        final int page = 1;
        final int total = SqlServerEmpleadosRepository.DEFAULT_LIMIT;
        ...
        final Pagination<Empleado> result = sqlServerEmpleadosRepository.getAll(page);
    ...
    public void testGetAllWithSearchParameterNull() {
        ...
        List<Empleado> records = this.generate(limit).getRecords();
        ...
        final Pagination<Empleado> result = sqlServerEmpleadosRepository.getAll(page, limit);
    ...
    public void testGetAllWithAllParameters() {
        ...
        final Pagination<Empleado> result = sqlServerEmpleadosRepository.getAll(page, limit, buscar);
    ...
    private Pagination<Empleado> generate(int total) {
        ...
        return mockEmpleadoRepository.getAll(1, total);
    }
}
